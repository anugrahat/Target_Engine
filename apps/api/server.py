...
def main() -> int:
    ...
    print("Routes: /health, /benchmarks, /subsets, /dataset-manifests, /study-contrasts, /contrast-readiness, /open-targets-genetics, /open-targets-tractability, /fused-target-evidence, /transcriptomics-evidence, /transcriptomics-real-scores, /transcriptomics-fixture-scores")
    try:
