...
def main() -> int:
    ...
    print("Routes: /health, /benchmarks, /subsets, /dataset-manifests, /study-contrasts, /contrast-readiness, /transcriptomics-evidence, /transcriptomics-real-scores, /transcriptomics-fixture-scores")
    try:
